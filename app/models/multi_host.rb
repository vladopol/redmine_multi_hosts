class MultiHost < ActiveRecord::Base
  ...
  EDITABLE_ATTRIBUTES = %w(internal_name default_mail_from app_title default_group_id default_easy_user_type_id smtp_address smtp_port smtp_user smtp_password smtp_authentication)
